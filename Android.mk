...
RECOVERY_NAME := CWM-based Galaxy S2 wimax Recovery
BOARD_USE_CUSTOM_RECOVERY_FONT := \"roboto_15x24.h\"
...
LOCAL_CFLAGS += -DRECOVERY_HAVE_SD_EXT
...
RECOVERY_VERSION := $(RECOVERY_NAME) v6.0.1.2_r15

LOCAL_CFLAGS += -DRECOVERY_VERSION="$(RECOVERY_VERSION)"
RECOVERY_API_VERSION := 2
LOCAL_CFLAGS += -DRECOVERY_API_VERSION=$(RECOVERY_API_VERSION)

LOCAL_CFLAGS += -DRECOVERY_TZ_JPN
LOCAL_CFLAGS += -DBOARD_HAS_SDCARD_INTERNAL
...
RECOVERY_LINKS := edify busybox flash_image dump_image mkyaffs2image unyaffs erase_image nandroid reboot volume setprop getprop dedupe minizip
